...
app.get('/stocks/sort/growth', (req, res) => {
  ...
  let sortedStocks = stocks.slice(); // Create a copy of the stocks array

  // Sort stocks based on growth rate
  if (growth === 'high-to-low') {
    sortedStocks.sort((a, b) => b.growth - a.growth); // Sort high-to-low
  } else {
    sortedStocks.sort((a, b) => a.growth - b.growth); // Sort low-to-high (default)
  }
...
//https://stackblitzstartersyudd2g-swkm--3010--34c588ed.local-credentialless.webcontainer.io/stocks/filter/exchange?exchange=bse
...
app.get('/stocks', (req, res) => {
  res.json({ stocks: stocks }); // Send all stocks as JSON
});
